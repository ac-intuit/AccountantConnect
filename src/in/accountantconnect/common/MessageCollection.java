package in.accountantconnect.common;
...
public class MessageCollection {
   ...
   public static final String ACCOUNTANT_DOES_NOT_EXIST_NEEDED_BEFORE_CREATING_PROFILE = "The accountant does not exist. An account needs to be created first, before creating a profile.";
   public static final String ACCOUNTANT_DOES_NOT_EXIST_NEEDED_BEFORE_CHOOSING_PASSWORD = "The accountant does not exist. An account needs to be created first, before choosing a password.";
