...
public class AccountantReviewDao implements BaseDao{
	...
	public Object readById(int profileId) throws CommonException{
		Session session = sessionFactory.getCurrentSession();
		Criteria criteria = session.createCriteria(AccountantProfile.class);
